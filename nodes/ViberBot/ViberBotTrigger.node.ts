		...
		webhooks: [
			{
				...
				path: '={{$parameter["path"] || $workflow.id}}',
				isFullPath: true,
			},
		],
		properties: [
			{
				...
				description: 'The custom path segment of your webhook URL. If left empty, n8n automatically falls back to your unique workflow ID.',
			},
			{
